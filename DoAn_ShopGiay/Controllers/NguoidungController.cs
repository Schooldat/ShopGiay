...
namespace DoAn_ShopGiay.Controllers
{
    public class NguoidungController : Controller
    {
        ...
        public ActionResult ChangePassword(FormCollection collection)
        {
            ...
            {
                return Json(new { msg = "Vui lòng điền đầy đủ thông tin!", url = "/NguoiDung/ChangePassword" });
            }
            if (!pass.Equals(rppass))
            {
                return Json(new { msg = "Mật khẩu không trùng khớp!", url = "/NguoiDung/ChangePassword" });
            }
            ...
            codecheck = null;
            emailcheck = null;
            return Json(new { msg = "Đổi mật khẩu thành công!", url = "/NguoiDung/Dangnhap" });
        }
    }
}